...
<template>
  <UContainer>
    <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-ceramic-xl items-center">
      <!-- Image Section -->
      ...
      <div>
        ...
        <div class="mb-ceramic-md">
          ...
          <p class="text-stone-600 leading-relaxed lowercase">
            Have a question, an idea, or a piece you’d like to bring to life? Whether you’re looking
            for custom tableware for your home, a small collection for your café or restaurant, or a
            unique gift, I’d love to hear from you. Share a few details below and we’ll start
            shaping your ju_keramia piece together.
          </p>
        </div>
        ...
        >
          <div class="flex items-center gap-ceramic-xs">
            <UIcon name="i-heroicons-exclamation-triangle" class="text-red-600 !text-ceramic-lg" />
